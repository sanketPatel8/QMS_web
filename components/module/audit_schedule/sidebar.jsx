...
import { Home, Users, ClipboardList, Building2, BarChart3, Activity } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { id: 'checklists', label: 'Checklists', icon: ClipboardList, href: '/checklists'},
    { id: 'ncOfi', label: 'NC & OFI Management', icon: Building2, href: '/nc-ofi' },
    { id: 'reports', label: 'Report & Analytics', icon: BarChart3, href: '/reports' },
  ...
  return (
    <div className="w-[296px]  h-screen bg-gray-50 flex flex-col">
      {/* Header */}
